            ...
            <Tabs defaultValue="expenses">
                ...
                <TabsContent value="balances">
                    <Card>
                        ...
                        <CardContent>
                            {/* Mock Balances for Visualization */}
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        <Avatar className="h-8 w-8">
                                            <AvatarImage src={group.members[0].avatar} />
                                            <AvatarFallback>{group.members[0].name[0]}</AvatarFallback>
                                        </Avatar>
                                        <span className="text-sm font-medium">{group.members[0].name}</span>
                                    </div>
                                    <span className="text-success font-medium text-sm">gets back $450.00</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        <Avatar className="h-8 w-8">
                                            <AvatarImage src={group.members[1].avatar} />
                                            <AvatarFallback>{group.members[1].name[0]}</AvatarFallback>
                                        </Avatar>
                                        <span className="text-sm font-medium">{group.members[1].name}</span>
                                    </div>
                                    <span className="text-destructive font-medium text-sm">owes $120.00</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
